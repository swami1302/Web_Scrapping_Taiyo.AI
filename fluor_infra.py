...
# Define the URL
url = 'https://www.fluor.com/market-reach/industries/infrastructure'
...
try:
    ...
    second_elements = soup.find_all(class_='BodyContent_content__thrdX')
    ...
    with open('./sample3.csv', 'w', newline='', encoding='utf-8') as csvfile:
        # Create a CSV writer object
        writer = csv.writer(csvfile)

        # Write headers to the CSV file
        writer.writerow(['Content from SectionHeading_sectionTitleFirst__i4c3i', 
                         'Content from SectionHeading_sectionTitleSecond___SkZp'])  # Replace 'YourClassHere' with the third class name
